...
<head>
	...
	<title>Yikes | Danh sách sản phẩm</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						<h2>Giới thiệu Yikes </h2>
						<a href="/Yikes"><img src="/Yikes/assets/vendor/frontend/img/logo.png" alt="" style="width:50%; height:50%;"></a>
