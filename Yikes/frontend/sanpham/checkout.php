...
if (!isset($_SESSION['kh_tendangnhap_logged_frontend']) || empty($_SESSION['kh_tendangnhap_logged_frontend'])) {
	echo 'Vui lòng Đăng nhập trước khi Thanh toán! <a href="/Yikes/frontend/quanly/login.php">Click vào đây để đến trang Đăng nhập</a>';
	die;
} else {
	...
	//	$mail->SMTPDebug = 2;                                   // Enable verbose debug output
		...
		$body = <<<EOT
			<table border="1" width="100%">
				<tr>
					<td colspan="2">
						<img src="http://localhost/Yikes/assets/vendor/frontend/img/logo.png" style="width: 100px; height: 100px; border: 1px solid red;" />
					</td>
				</tr>
				<tr>
...
EOT;
	...
	echo 'Đặt hàng thành công. <a href="/Yikes">Bấm vào đây để quay về trang chủ</a>';
}
