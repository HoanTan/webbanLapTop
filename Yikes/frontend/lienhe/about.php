...
<body>
	...
	<?php include_once __DIR__.'/../layouts/partials/sidebar.php';?>
	 ...
	 <section class="breadcrumb-section set-bg" data-setbg="/Yikes/assets/vendor/frontend/img/breadcrumb.jpg">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 text-center">
					<div class="contact__widget">
						...
						<h4>Address</h4>
						<p>34/7 đường số 1 phường Long Thạnh Mỹ , Tp. Thủ Đức</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 text-center">
					<div class="contact__widget">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 text-center">
					<div class="contact__widget">
						...
						<h4>Email</h4>
						<p>nguyenhoantan24102002@gmail.com</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="map">
		<iframe
		 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.2532968950095!2d106.81260107451826!3d10.868329157492907!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317527550b97368f%3A0x46908b61fe39e3ab!2zMzQgxJDGsOG7nW5nIFPhu5EgMSwgTG9uZyBUaOG6oW5oIE3hu7ksIFF14bqtbiA5LCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1713019021447!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"
		...
		<div class="map-inside">
			...
			<div class="inside-widget">
				<h4>Việt Nam</h4>
				<ul>
					<li>Điện thoại: 0328774756</li>
					<li>Địa chỉ:34/7 đường số 1 phường Long Thạnh Mỹ , Tp. Thủ Đức </li>
				</ul>
			</div>
		</div>
	</div>
...
EOT;
				...
				$mail->send();
				echo '<script>
				location.href="/Yikes/frontend/lienhe/about.php";
