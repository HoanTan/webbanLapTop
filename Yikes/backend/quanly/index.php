...
<head>
	...
	<title>Yikes - Trang đăng nhập</title>
			...
			<div class="col-xl-10 col-lg-12 col-md-9">
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="card-body p-0">
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block " style="background-image: url('../../assets/vendor/backend/img/laptop.png');  background-position: center;background-size: cover; height: 400px; width: 600px;"></div>
							<div class="col-lg-6">
								<div class="p-5">
									...
									<h4>Bạn đã đăng nhập rồi. <br/> <a href="/Yikes/backend/index.php">Về trang chủ.</a></h4>
												...
												include_once(__DIR__ . '/../../dbconnect.php');
													if (isset($_POST['btnLogin'])) {
														...
														if (mysqli_num_rows($result) > 0) {
															...
															echo '<script>
																	location.href="/Yikes/backend/index.php";
